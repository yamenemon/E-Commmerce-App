      ...
      bottomNavigationBar: TopRoundedContainer(
        ...
        child: Padding(
          ...
          child: GlobalWidget.defaultButton(
              press: () {
                final isExist = _cartController.carts.indexWhere((element) =>
                    element.productDemoModel.productId == product.productId);
                if (isExist != -1) {
                  Get.snackbar(LocalizationLanguage.CART_TEXT.tr,
                      LocalizationLanguage.ITEM_ADDED_TEXT.tr,
                      snackPosition: SnackPosition.BOTTOM,
                      colorText: Colors.white,
                      backgroundColor: Colors.brown[400]);
                } else {
                  _cartController.changeCart(product, CART_STATUS.INCREMENT);
                }
              },
              text: "Add To Cart"),
        ),
